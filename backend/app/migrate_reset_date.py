...
async def migrate_reset_dates():
    ...
    try:
        ...
        await add_col("reset_month", "INTEGER", "1")
        await add_col("reset_day", "INTEGER", "1")
        
        print("Migration Reset Dates complete.")
        await conn.close()
    except Exception as e:
        print(f"Error: {e}")

if __name__ == "__main__":
    asyncio.run(migrate_reset_dates())
